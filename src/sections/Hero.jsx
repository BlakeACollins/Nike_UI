...
const Hero = () => {
  ...
  return (
   <section id="home" className=" flex justify-center xl:flex-row flex-col min-h-screen gap-10 max-container w-full">
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-;x:padding-x pt-28">
